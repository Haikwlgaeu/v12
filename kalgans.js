...
🌷 KALAU MAU RENAME TARO CREDITS GUA : © veenoo moods.☆ */
...
browser: ['© veenoo moods','Safari','1.0.0'],
auth: state,
version
})
...
let buttons = [
{buttonId: `© veenoo moods.☆`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
